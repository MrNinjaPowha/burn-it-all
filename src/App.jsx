    ...
    return (
      <div className="h-screen w-screen overflow-hidden">
        <div className="bg-metal-plates flex w-full items-center justify-between py-4 px-6">
          ...
          <button
            className="inline-block rounded bg-red-600 px-5 py-2.5 text-sm font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:scale-95 hover:bg-red-700 hover:shadow-lg focus-visible:scale-95 focus-visible:bg-red-700 focus-visible:shadow-lg active:scale-90 active:bg-red-800 active:shadow-lg"
